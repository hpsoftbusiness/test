            ...
            <ul class=\"cd-hero-slider\">
                <li class=\"selected\">
                    ...
                    <div class=\"cd-full-width\">
                        <h2>Znajdz experta IT i dzialaj natychmiast.</h2>
                        <h3>poraz pierwszy calkowicie po polsku i wspierajac Polske. </h3>
                        <a href=\"#0\" class=\"btn btn-primary white cd-btn\">Wykonaj prace</a>
                        <a href=\"#0\" class=\"btn btn-primary solid cd-btn\">Zlec prace</a>
                    </div> <!-- .cd-full-width -->
                </li>
                <li>
                    <div class=\"overlay2\">
        ...
        <div class=\"container\">
            <div class=\"row\">
                <div class=\"col-md-12 heading\">
                    ...
                    <h2 class=\"title\">Czym sie zajmujemy <span class=\"title-desc\">Moze pomoc Ci w ale nie tylko:</span></h2>
                </div>
            </div><!-- Title row end -->
                ...
                <div class=\"col-md-12\">
                    <div class=\"col-md-3 col-sm-3 wow fadeInDown\" data-wow-delay=\".5s\">
                        <div class=\"service-content text-center\">
                            ...
                            <h3>Tworzenie designu</h3>
                            <p>Potrzebujesz projekt graficzny dla Twojego aplikacji?</p>
                        </div>
                    ...
                    <div class=\"col-md-3 col-sm-3 wow fadeInDown\" data-wow-delay=\".8s\" >
                        <div class=\"service-content text-center\">
                            ...
                            <h3>Programowanie</h3>
                            <p>Potrzebujesz dokonczyc projekt? Zlecic czesc pracy? Masz pojedyncze zadania?</p>
                        </div>
                    ...
                    <div class=\"col-md-3 col-sm-3 wow fadeInDown\" data-wow-delay=\"1.1s\">
                        <div class=\"service-content text-center\">
                            ...
                            <h3>Sprzet</h3>
                            <p>Konfiguracja komputera? Konfiguracja urzedzen sieciowych ? Problem ze sprzetem?  </p>
                        </div>
                    ...
                    <div class=\"col-md-3 col-sm-3 wow fadeInDown\" data-wow-delay=\"1.4s\">
                        <div class=\"service-content text-center\">
                            ...
                            <h3>Doradztwo IT</h3>
                            <p>Masz problem it ale jestes ekspertem w innej branzy? Chcialbys doradzic sie?</p>
                        </div>
                    </div><!--/ End 4th service -->
                </div>
            </div><!-- Content row end -->
        ...
        <div class=\"container\">
            <div class=\"row\">
                <div class=\"col-md-12 heading\">
                    ...
                    <h2 class=\"title classic\">Przyklady naszej pracy</h2>
                </div>
            </div> <!-- Title row end -->
